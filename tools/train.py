...
from train_utils.train_utils_eval import train_model
# from train_utils.train_kd_utils import train_model_kd
from train_utils.train_kd_utils_eval import train_model_kd
...
def parse_config():
    ...
    if cfg.get('KD', None) and cfg.KD.ENABLED:
        kd_utils.process_kd_config(cfg)
...
def main():
    ...
    if cfg.get('KD', None) and cfg.KD.ENABLED:
        ...
        kd_utils.prepare_kd_modules(teacher_model, model, cfg)
    else:
        teacher_model = None
