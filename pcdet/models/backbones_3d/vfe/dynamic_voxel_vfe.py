...
class DynamicVoxelVFE(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        # Vizualize ocupied voxels in the grid
        # import numpy as np
        # import matplotlib.pyplot as plt
        # aaa = voxel_coords.detach().cpu().numpy()
        # bbb = np.zeros((self.grid_size[0], self.grid_size[1]))
        # bbb[aaa[:, 2], aaa[:, 3]] = 1
        # plt.imshow(bbb, cmap='gray', interpolation='nearest')
        # plt.show()
