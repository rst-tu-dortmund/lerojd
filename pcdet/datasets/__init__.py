...
from .VoD_lidar.VoD_dataset_lidar import VoDDataset_lidar
from .VoD_lidar_radar.VoD_dataset_lidar_radar import VoDDataset_lidar_radar
...
__all__ = {
    ...
    'VoDDataset_lidar': VoDDataset_lidar,
    'VoDDataset_lidar_radar': VoDDataset_lidar_radar
}
