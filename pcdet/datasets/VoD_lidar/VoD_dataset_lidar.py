...
class VoDDataset_lidar(DatasetTemplate):
    ...
    def include_VoD_data(self, mode):
        ...
        for info_path in self.dataset_cfg.INFO_PATH[mode]:
            ...
            if not os.path.isfile(info_path): # info_path.exists()
                continue
...
def create_VoD_lidar_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    dataset = VoDDataset_lidar(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
